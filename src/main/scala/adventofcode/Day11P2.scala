...
object MonkeyBusiness:
  ...
  class Monkey(val id: Int, val items: List[Long], worryFn: WorryFn, val mod: Long, yes: Int, no: Int, val inspections: Long):
  ...
  def run (monkeys: IndexedSeq[Monkey], rounds: Int, commonMultiple: Long): Long =
